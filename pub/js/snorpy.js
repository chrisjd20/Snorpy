...
$("#srcip").focusout(function(){
    if ($("#srcip").val().match(expression) !== null || $("#srcip").val().match(/^(?:\!|\(|\$){1,2}(?:\.|\,|\w|\_|\d|\s|\!|\(|\))+\)?$/g) !== null || $("#srcip").val() === '' || $("#srcip").val() === 'any'){
...
$("#dstip").focusout(function(){
    if ($("#dstip").val().match(expression) !== null || $("#dstip").val().match(/^(?:\!|\(|\$){1,2}(?:\.|\,|\w|\_|\d|\s|\!|\(|\))+\)?$/g) !== null || $("#dstip").val() === '' || $("#dstip").val() === 'any'){
